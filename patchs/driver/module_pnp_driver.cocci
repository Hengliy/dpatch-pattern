/// use module_pnp_driver to simplify the code
///
/// module_pnp_driver() makes the code simpler by eliminating
/// boilerplate code.
///
@r1@
identifier fn_init;
...
int fn_init(void)
{
	return pnp_register_driver(&driver);
}
