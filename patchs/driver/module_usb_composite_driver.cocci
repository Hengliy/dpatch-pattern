/// use module_usb_composite_driver to simplify the code
///
...
int fn_init(void)
{
	return usb_composite_probe(&driver);
}
...
{
	usb_composite_unregister(&driver);
}
...
identifier r1.fn_init;
identifier r1.driver;
declarer name module_usb_composite_driver;
@@
...
-	usb_composite_unregister(&driver);
-}
+ module_usb_composite_driver(driver);
