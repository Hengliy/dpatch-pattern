/// use mdio_module_driver to simplify the code
///
...
int fn_init(void)
{
	return mdio_driver_register(&driver);
}
...
identifier r1.fn_init;
identifier r1.driver;
declarer name mdio_module_driver;
@@
