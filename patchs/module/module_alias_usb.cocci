/// export USB module alias information
///
/// Flags: 8
///
 ...
 *
 * MODULE_DEVICE_TABLE(usb, matchs)
 */
@usb_ids depends on ismod@
identifier ids;
position p != ok1.p;
@@
struct usb_device_id ids@p[] = { ... };

@usb_driver@
identifier drv, usb_ids.ids;
@@
...
@usb_p1 depends on ismod && usb_driver@
identifier usb_ids.ids;
@@
